var init = function (window) {
    ...
    window.opspark.makeGame = function () {
        ...
        function drawCircle() {
            ...
            physikz.addRandomVelocity(circle, canvas, 8, 7);
        ...
        */
        function update() {
            for (var ball = 0; ball < circles.length; ball++){
                var everyCircle = circles[ball];
                physikz.updatePosition(everyCircle)
                game.checkCirclePosition(everyCircle)
            }
            // TODO 4 : Update the circle's position //
            //code got replaced with a more compact version
